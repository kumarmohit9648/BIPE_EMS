...
public class EventActivity extends AppCompatActivity implements View.OnClickListener, OnItemClickGetPosition {
        ...
        public void OnResponseAPI(Object object) {
            try {
                ...
                if (jsonObject.getString("flag").equalsIgnoreCase("true")) {
                    ...
                    Toast.makeText(EventActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    private void setAdaptor(List<EventListResponse.Events> events) {
        ...
        adaptor.getValuePosition(EventActivity.this);
    }
    ...
    public void getPosition(int position) {
        Intent intent = new Intent(EventActivity.this, InviteeActivity.class);
