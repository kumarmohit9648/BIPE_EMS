...
public class InviteeActivity extends AppCompatActivity implements OnItemClickGetPosition, View.OnClickListener {

    private static final String TAG = "InviteeActivity";
    ...
    private void getInviteeList() {
        try {
            ...
            APITransaction.startNetworkService(request, invitationListResponse);
    ...
    APIResponse invitationListResponse = new APIResponse() {
        @Override
        public void OnResponseAPI(Object object) {
            try {
                ...
                if (jsonObject.getString("flag").equalsIgnoreCase("true")) {
                    ...
                    Toast.makeText(InviteeActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public void OnErrorAPI(String error) {
            dialog.cancel();
            Toast.makeText(InviteeActivity.this, error, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private void setAdaptor(List<InvitationListResponse.Invitation> events) {
        ...
        adaptor.getValuePosition(InviteeActivity.this);
    }
    ...
    public void getPosition(int position) {
        Intent intent = new Intent(InviteeActivity.this, EditInviteeActivity.class);
